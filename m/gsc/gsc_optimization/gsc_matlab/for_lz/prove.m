...
hwt2 = waitbar(0, 'reconstruct process');
...
for p = atf_length : FrameNum_atf
    ...
    elseif p > moments_frame(moment_frame_index + 1)
        ...
        out_signal(1:FreLen_atf, 1) = atf_moments_plot_1_c(:, moment_length_index + 1) .* fv1;
        ...
        out_signal(1:FreLen_atf, 2) = atf_moments_plot_2_c(:, moment_length_index + 1) .* fv1;
        ...
        out_signal(1:FreLen_atf, 3) = atf_moments_plot_3_c(:, moment_length_index + 1) .* fv1;
        ...
        out_signal(1:FreLen_atf, 4) = atf_moments_plot_4_c(:, moment_length_index + 1) .* fv1;
        ...
        out_signal(1:FreLen_atf, 5) = atf_moments_plot_5_c(:, moment_length_index + 1) .* fv1;
        ...
        out_signal(1:FreLen_atf, 6) = atf_moments_plot_6_c(:, moment_length_index + 1) .* fv1;
...
%return;
%% save result for atf
result_folder = './aj_185_1m_d2/c/only_phase/';
for m = 1 : MicNum
