...
load ./6mic_xiaoyu/abm.txt
load ./6mic_xiaoyu/aic.txt
load ./6mic_xiaoyu/beta.txt
load ./6mic_xiaoyu/c_beta.txt
%{
load ./6mic_xiaoyu/f_m_pf_nsr.txt
load ./6mic_xiaoyu/f_m_pf_nsr_noi.txt
load ./6mic_xiaoyu/f_m_pf_snr.txt
load ./6mic_xiaoyu/f_m_pf_snr_noi.txt
%}
fs = 16000;
frameL = 32;
%% 时间是一分40， 到2分25
