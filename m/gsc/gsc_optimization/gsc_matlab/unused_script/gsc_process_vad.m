...
h_mat_max = zeros(FreLen_atf, MicNum);
atf_moments_plot_1_max = zeros(FreLen_atf, moment_frame_size/2);
atf_moments_plot_2_max = zeros(FreLen_atf, moment_frame_size/2);
atf_moments_plot_3_max = zeros(FreLen_atf, moment_frame_size/2);
atf_moments_plot_4_max = zeros(FreLen_atf, moment_frame_size/2);
atf_moments_plot_5_max = zeros(FreLen_atf, moment_frame_size/2);
atf_moments_plot_6_max = zeros(FreLen_atf, moment_frame_size/2);
...
for p = atf_length : FrameNum_atf
    ...
    elseif p > moments_frame(moment_frame_index + 1)
        ...
        atf_moments_plot_1_max(:, moment_length_index) = max(h_mat_plot_1(:, p-moment_length:p-1), [], 2);
        atf_moments_plot_2_max(:, moment_length_index) = max(h_mat_plot_2(:, p-moment_length:p-1), [], 2);
        atf_moments_plot_3_max(:, moment_length_index) = max(h_mat_plot_3(:, p-moment_length:p-1), [], 2);
        atf_moments_plot_4_max(:, moment_length_index) = max(h_mat_plot_4(:, p-moment_length:p-1), [], 2);
        atf_moments_plot_5_max(:, moment_length_index) = max(h_mat_plot_5(:, p-moment_length:p-1), [], 2);
        atf_moments_plot_6_max(:, moment_length_index) = max(h_mat_plot_6(:, p-moment_length:p-1), [], 2);
...
%         h_mat_plot_1(:, p) = h_mat(:, 1) ./ abs(h_mat(:, 1));
%         h_mat_plot_2(:, p) = h_mat(:, 2) ./ abs(h_mat(:, 2));
%         h_mat_plot_3(:, p) = h_mat(:, 3) ./ abs(h_mat(:, 3));
%         h_mat_plot_4(:, p) = h_mat(:, 4) ./ abs(h_mat(:, 4));
%         h_mat_plot_5(:, p) = h_mat(:, 5) ./ abs(h_mat(:, 5));
%         h_mat_plot_6(:, p) = h_mat(:, 6) ./ abs(h_mat(:, 6));
%         
        h_mat_max(:, 1) = max(h_mat_plot_1(:, p - 9:p), [], 2);
        h_mat_max(:, 2) = max(h_mat_plot_2(:, p - 9:p), [], 2);
        h_mat_max(:, 3) = max(h_mat_plot_3(:, p - 9:p), [], 2);
        h_mat_max(:, 4) = max(h_mat_plot_4(:, p - 9:p), [], 2);
        h_mat_max(:, 5) = max(h_mat_plot_5(:, p - 9:p), [], 2);
        h_mat_max(:, 6) = max(h_mat_plot_6(:, p - 9:p), [], 2);
        
%         h_mat_plot_1(:, p) = alpha * h_mat_plot_1(:, p-1) + (1 - alpha) * h_mat(:, 1);
%         h_mat_plot_2(:, p) = alpha * h_mat_plot_2(:, p-1) + (1 - alpha) * h_mat(:, 2);
%         h_mat_plot_3(:, p) = alpha * h_mat_plot_3(:, p-1) + (1 - alpha) * h_mat(:, 3);
%         h_mat_plot_4(:, p) = alpha * h_mat_plot_4(:, p-1) + (1 - alpha) * h_mat(:, 4);
%         h_mat_plot_5(:, p) = alpha * h_mat_plot_5(:, p-1) + (1 - alpha) * h_mat(:, 5);
%         h_mat_plot_6(:, p) = alpha * h_mat_plot_6(:, p-1) + (1 - alpha) * h_mat(:, 6);
%         
%         h_mat_temp(:, 1) = h_mat_plot_1(:, p);
%         h_mat_temp(:, 2) = h_mat_plot_2(:, p);
%         h_mat_temp(:, 3) = h_mat_plot_3(:, p);
%         h_mat_temp(:, 4) = h_mat_plot_4(:, p);
%         h_mat_temp(:, 5) = h_mat_plot_5(:, p);
%         h_mat_temp(:, 6) = h_mat_plot_6(:, p);
        
%         temp = fft(voice1(p, :)');
%         temp = temp(1:FreLen_atf);

%         for j = 1: MicNum
% %             out_signal(1:FreLen_atf, j) = h_mat_temp(:, j) .* fv(:, 1);
%             out_signal(1:FreLen_atf, j) = h_mat(:, j) ./abs(h_mat(:, j)) .* fv(:, 1);
...
% atf_moments_plot_1 = atf_moments_plot_1 ./ abs(atf_moments_plot_1);
% atf_moments_plot_2 = atf_moments_plot_2 ./ abs(atf_moments_plot_2);
% atf_moments_plot_3 = atf_moments_plot_3 ./ abs(atf_moments_plot_3);
% atf_moments_plot_4 = atf_moments_plot_4 ./ abs(atf_moments_plot_4);
% atf_moments_plot_5 = atf_moments_plot_5 ./ abs(atf_moments_plot_5);
% atf_moments_plot_6 = atf_moments_plot_6 ./ abs(atf_moments_plot_6);
...
% 
% atf_moments_plot_1_max = atf_moments_plot_1_max ./ abs(atf_moments_plot_1_max);
% atf_moments_plot_2_max = atf_moments_plot_2_max ./ abs(atf_moments_plot_2_max);
% atf_moments_plot_3_max = atf_moments_plot_3_max ./ abs(atf_moments_plot_3_max);
% atf_moments_plot_4_max = atf_moments_plot_4_max ./ abs(atf_moments_plot_4_max);
% atf_moments_plot_5_max = atf_moments_plot_5_max ./ abs(atf_moments_plot_5_max);
% atf_moments_plot_6_max = atf_moments_plot_6_max ./ abs(atf_moments_plot_6_max);
% 
% for p = atf_length : FrameNum_atf
%     lp = (p - 1) * Frame_inc_atf + 1:(p - 1) * Frame_inc_atf + Frame_len_atf;
%     if p < moments_frame(moment_frame_index)
...
%         fv1 = fv1(1:FreLen_atf, :);
% 
%         out_signal(1:FreLen_atf, 1) = atf_moments_plot_1_max(:, moment_length_index + 1) .* fv1;
%         out_signal(Frame_len_atf/2 + 2:Frame_len_atf, 1) = conj(out_signal(Frame_len_atf/2: -1: 2, 1));
%         out_signal_temp = real(ifft(out_signal(1:Frame_len_atf, 1)));
%         sig_mic_reconstruct(lp, 1) = sig_mic_reconstruct(lp, 1) + out_signal_temp;
%         
%         out_signal(1:FreLen_atf, 2) = atf_moments_plot_2_max(:, moment_length_index + 1) .* fv1;
%         out_signal(Frame_len_atf/2 + 2:Frame_len_atf, 2) = conj(out_signal(Frame_len_atf/2: -1: 2, 2));
%         out_signal_temp = real(ifft(out_signal(1:Frame_len_atf, 2)));
%         sig_mic_reconstruct(lp, 2) = sig_mic_reconstruct(lp, 2) + out_signal_temp;
%             
%         out_signal(1:FreLen_atf, 3) = atf_moments_plot_3_max(:, moment_length_index + 1) .* fv1;
%         out_signal(Frame_len_atf/2 + 2:Frame_len_atf, 3) = conj(out_signal(Frame_len_atf/2: -1: 2, 3));
%         out_signal_temp = real(ifft(out_signal(1:Frame_len_atf, 3)));
%         sig_mic_reconstruct(lp, 3) = sig_mic_reconstruct(lp, 3) + out_signal_temp;
%             
%         out_signal(1:FreLen_atf, 4) = atf_moments_plot_4_max(:, moment_length_index + 1) .* fv1;
%         out_signal(Frame_len_atf/2 + 2:Frame_len_atf, 4) = conj(out_signal(Frame_len_atf/2: -1: 2, 4));
%         out_signal_temp = real(ifft(out_signal(1:Frame_len_atf, 4)));
%         sig_mic_reconstruct(lp, 4) = sig_mic_reconstruct(lp, 4) + out_signal_temp;
%             
%         out_signal(1:FreLen_atf, 5) = atf_moments_plot_5_max(:, moment_length_index + 1) .* fv1;
%         out_signal(Frame_len_atf/2 + 2:Frame_len_atf, 5) = conj(out_signal(Frame_len_atf/2: -1: 2, 5));
%         out_signal_temp = real(ifft(out_signal(1:Frame_len_atf, 5)));
%         sig_mic_reconstruct(lp, 5) = sig_mic_reconstruct(lp, 5) + out_signal_temp;
%             
%         out_signal(1:FreLen_atf, 6) = atf_moments_plot_6_max(:, moment_length_index + 1) .* fv1;
%         out_signal(Frame_len_atf/2 + 2:Frame_len_atf, 6) = conj(out_signal(Frame_len_atf/2: -1: 2, 6));
%         out_signal_temp = real(ifft(out_signal(1:Frame_len_atf, 6)));
%         sig_mic_reconstruct(lp, 6) = sig_mic_reconstruct(lp, 6) + out_signal_temp;    
%     end
...
for m = 1 : MicNum
    ...
    wavname_construct = ['rec_mic_construct3_' num2str(m) '.wav'];
